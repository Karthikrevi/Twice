...
// TODO: dedicated manager tables view coming later — reuse the shared
// TablesScreen for now.
...
const tabs: { key: TabKey; label: string; lock?: boolean }[] = [
  { key: "orders", label: "Orders" },
  { key: "dinein", label: "Dine-in" },
  { key: "finance", label: "Finance", lock: true },
